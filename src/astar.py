...
def astar_path(G, source, target, dic, heuristic=None, weight='weight'):
...
def astar_path_length(G, source, target, dic, heuristic=None, weight='weight'):
    ...
    path = astar_path(G, source, target, dic, heuristic, weight)
