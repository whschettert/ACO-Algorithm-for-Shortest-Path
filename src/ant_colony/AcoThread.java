...
public class AcoThread implements Runnable {
	...
	private static final double RANDOM_COEFFICIENT = 0.2;
	...
	public AcoThread(Graph graph, Node source, Node target, int ant_thread_index, int ants_by_thread, Ant[] ants, String weight, double alpha, double beta) {
		this.graph = graph;
		this.source = source;
		this.target = target;
